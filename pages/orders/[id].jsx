...
const Order = () => {
    ...
    return (
        <div className={styles.container}>
                ...
                <tr>
                    <td>
                        <span className={styles.idx}>123459876</span>
                    </td>
                    <td>
                        <span className={styles.name}>Adetunji Sadiq</span>
                    </td>
                    <td>
                        <span className={styles.address}>No 8 Adetunji strt Agbati Alakia</span>
                    </td>
                    <td>
